...
public class Final13Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn10 = findViewById(R.id.btn_store13);
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.btn_store10:
                    clicked_btn10("https://map.naver.com/v5/entry/place/1377509210?c=14127779.5009208,4506908.7256362,13,0,0,0,dh&placePath=%2Fhome%3Fentry=plt");
                    break;
