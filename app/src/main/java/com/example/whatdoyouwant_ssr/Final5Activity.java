...
public class Final5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn10 = findViewById(R.id.btn_store5);
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.btn_store10:
                    clicked_btn10("https://map.naver.com/v5/entry/place/1372378905?c=14127798.6101779,4506803.6247223,13,0,0,0,dh&placePath=%2Fhome%3Fentry=plt");
                    break;
