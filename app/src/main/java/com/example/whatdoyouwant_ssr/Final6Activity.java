...
public class Final6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn10 = findViewById(R.id.btn_store6);
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.btn_store10:
                    clicked_btn10("https://map.naver.com/v5/entry/place/20860539?c=14129143.4241443,4506741.5196368,15,0,0,0,dh&placePath=%3Fentry=plt");
                    break;
